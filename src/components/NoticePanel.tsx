...
const NOTICE_LIST: NoticeItem[] = [
  {
    date: "2026-07-08",
    tag: "新功能",
    content: "图片裁剪升级：支持自由比例裁剪，可拖拽四角调整裁剪框大小，新增「默认卡片比例」一键适配卡片尺寸",
  },
  {
    date: "2026-07-08",
    tag: "新功能",
    content: "视频比例裁剪：上传视频时进入专属比例裁剪界面，支持3:4、1:1、16:9、4:3、9:16五种预设比例",
  },
  {
    date: "2026-07-08",
    tag: "优化",
    content: "照片墙视频自动播放：球体中的视频自动静音播放，点击可全屏播放和下载",
  },
  {
    date: "2026-07-09",
    tag: "优化",
    content: "移动端加载优化：进入主页不再预加载所有成员详情大图，改为按需加载，大幅提升手机端打开速度",
  },
  {
    date: "2026-07-09",
    tag: "优化",
    content: "移动端视频预加载策略优化：仅加载元数据不下载完整视频，减少带宽占用",
  },
  {
    date: "2026-07-09",
    tag: "优化",
    content: "移动端预加载并发降低：从6个并发降为3个，每批间隔80ms，避免Safari浏览器阻塞",
  },
  {
    date: "2026-07-09",
    tag: "修复",
    content: "修复Safari浏览器3D效果不显示的问题，添加-webkit-前缀兼容",
  },
  {
    date: "2026-07-08",
    tag: "新功能",
    content: "照片墙悬停编辑按钮：管理员可编辑所有照片，社员可编辑自己上传的照片",
  },
  {
    date: "2026-07-08",
    tag: "新功能",
    content: "视频上传支持自由剪裁，可拖拽调整剪裁区域，支持多种比例快捷切换",
  },
  {
    date: "2026-07-08",
    tag: "优化",
    content: "照片墙实时更新：开启Supabase Realtime，任何用户更改后所有在线用户自动同步",
  },
  {
    date: "2026-07-08",
    tag: "优化",
    content: "照片墙视频自动循环播放，进入可视区域自动播放，离开自动暂停",
  },
  {
    date: "2026-07-08",
    tag: "修复",
    content: "修复编辑照片裁剪后保存失败的问题，缓存id与数据库id不匹配导致更新0行",
  },
  {
    date: "2026-07-08",
    tag: "修复",
    content: "修复视频在照片墙黑屏不显示的问题，video元素不触发load事件导致opacity为0",
  },
  {
    date: "2026-07-08",
    tag: "修复",
    content: "修复竖屏视频剪裁框无法向右拖动的问题，剪裁区域现在限制在视频实际显示范围内",
  },
  {
    date: "2026-07-08",
    tag: "优化",
    content: "移除视频封面选择功能，简化上传流程",
  },
  {
    date: "2026-07-08",
    tag: "修复",
